...
@implementation TiAdvanceddatabaseModule
...
-(id)open:(id)path
{
	...
	TiAdvanceddatabaseProxy *db = [[[TiAdvanceddatabaseProxy alloc] _initWithPageContext:[self executionContext] args:nil] autorelease];
	[db open:path];
	return db;
}
